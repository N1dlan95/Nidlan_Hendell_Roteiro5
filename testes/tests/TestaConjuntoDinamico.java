...
public class TestaConjuntoDinamico {
	...
	/**
	 * Não quero editar os testes, porem não faz sentido retornar que o elemento nao foi encontrado após a remoção de todos,
	 * pois se tudo foi removido deveria retornar que o conjunto esteja vazio, então nem tem oque procurar
	 ...
	 *
	 * 		assertEquals(5,cd.predecessor(10));
	 * ele deseja que o predecessor de 10 seja 5, se fosse em valor, como o teste abaixo sugere seria 8
	 *
	 ...
	 * 	deseja que o predecessor seja o -2147483648, porem so seria possivel se ordenasse,
	 * 	mas ja que no teste do minimo e maximo segue outra lógica, da erro :C
	 *
	 *
	 * @author Nidlan Hendell
	 *
	...
	public void edgeCases_MinAndMaxIntegerValues() throws ElementoNaoEncontradoException, ConjuntoDinamicoVazioException {
		...
		assertEquals(Integer.MIN_VALUE, cd.predecessor(0));//erro aqui
